...
#define DEFAULT_TERMINAL_ADDR 0X02
//无线指令类型
...
#define UART_ACK_SEND_TO_TERMINAL_OK 0X02
#define UART_ACK_GET_FROM_GATEWAY_OK 0X03
#define UART_ACK_GET_FROM_TERMINAL_OK 0X04
#define UART_RF_SEND_TERMINAL_ADDR_OK 0X05
#define UART_RF_SET_TERMINAL_ADDR_OK 0X06
#define UART_SET_LOCAL_ADDR_OK 0X07
#define UART_RF_DATA_SEND_OK 0X08
#define UART_RF_SEND_CCA_BUSY 0X09
#define UART_ACK_SEND_TO_GATEWAY_FAIL 0X0A
#define UART_ACK_SEND_TO_TERMINAL_FAIL 0X0B
#define UART_RF_SEND_TERMINAL_ADDR_FAIL 0X0C
#define UART_RF_DATA_SEND_FAIL 0X0D
/* Exported macro ------------------------------------------------------------*/
